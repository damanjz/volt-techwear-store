          ...
          <div className="w-full md:w-2/3 flex flex-col gap-8">
            ...
            <div className="bg-background/40 backdrop-blur-sm border border-white/10 p-8">
              ...
              <div className="space-y-4">
                {/* Mock Item 1 */}
                <div className="border border-white/5 bg-black/50 p-4 flex justify-between items-center">
                  <div>
                    <div className="font-mono text-[10px] text-volt mb-1">REQ_ID: #VLT-0094-1</div>
                    <div className="font-sans font-medium">Aegis Utility Jacket // V2</div>
                    <div className="font-mono text-xs text-foreground/50 mt-1">Status: DEPLOYED (via Drone)</div>
                  </div>
                  <div className="font-mono font-bold">$345.00</div>
                </div>
                {/* Mock Item 2 */}
                <div className="border border-white/5 bg-black/50 p-4 flex justify-between items-center opacity-70">
                  <div>
                    <div className="font-mono text-[10px] text-foreground/50 mb-1">REQ_ID: #VLT-0042-8</div>
                    <div className="font-sans font-medium text-foreground/80">Volt Schematic Sticker Pack</div>
                    <div className="font-mono text-xs text-foreground/40 mt-1">Status: DELIVERED</div>
                  </div>
                  <div className="font-mono font-bold text-foreground/60">$15.00</div>
                </div>
              </div>
            </div>
