...
export default function BlackSiteClient({ initialProducts }: BlackSiteProps) {
      ...
      <section className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {initialProducts.map((item) => {
            // Determine required clearance based on ID or metadata
            const reqClearance = item.id === 'bs-01' ? 2 : 3;
            const isLocked = clearanceLevel < reqClearance;
                    ...
                    <>
                      ...
                      <div className="relative z-30 flex flex-col items-center justify-center bg-black/80 border border-cyber-red/30 p-6">
                        ...
                        <span className="font-mono text-xs uppercase text-foreground/50 text-center">
                          {"Requires Lvl " + reqClearance + " Clearance"}
                        </span>
                      </div>
                    </>
                  ) : (
